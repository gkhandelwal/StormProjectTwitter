...
public class TweetSpout extends BaseRichSpout
{
  ...
  private class TweetListener implements StatusListener {
    ...
    {
      double latitude = status.getGeoLocation() == null ? 0: status.getGeoLocation().getLatitude();
      double longitude = status.getGeoLocation() == null ? 0: status.getGeoLocation().getLongitude();
      queue.offer(status.getText() + TweetTopology.DELIMITER + String.valueOf(latitude) + TweetTopology.GEODELIMITER + String.valueOf(longitude));
      ...
      SpoutOutputCollector    spoutOutputCollector)
  {
    ...
    //Filter twitter according to language
