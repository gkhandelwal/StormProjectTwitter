...
public class RankableObjectWithFields implements Rankable, Serializable {
  ...
  public RankableObjectWithFields(Object obj, long count, Object geoLocation, Object... otherFields) {
    if (obj == null) {
  ...
  public static RankableObjectWithFields from(Tuple tuple) {
    ...
    Object geolocation = otherFields.remove(0);
    return new RankableObjectWithFields(obj, count, geolocation,otherFields.toArray());
  }
  ...
  public Rankable copy() {
    ...
    return new RankableObjectWithFields(getObject(), getCount(), getGeoLocation(), shallowCopyOfFields);
  }
