...
public final class SlidingWindowCounter<T> implements Serializable {
  ...
  public void incrementCount(T obj, T geo) {
    objCounter.incrementCount(obj, geo, headSlot);
  }
  ...
  // dont mimic above one as this will delete twice.. Always call before getCountsThenAdvanceWindow()
  public Map<T, String> getGeoThenAdvanceWindow() {
    Map<T, String> geo = objCounter.getGeolocations();
    return geo;
  }
